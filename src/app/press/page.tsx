...
export const metadata: Metadata = {
  title: "Press",
  description:
    "BottleExpress in the press — announcements, media resources, and contacts for journalists and partners.",
};

const releases = [
  {
    date: "March 2026",
    title: "BottleExpress surpasses 120,000 bottles authenticated",
    excerpt:
  ...
  {
    date: "June 2025",
    title: "BottleExpress partners with twelve independent distilleries",
    excerpt:
...
export default function PressPage() {
  return (
    <PageShell
      eyebrow="Company"
      title="Press & Media"
      lede="Resources for journalists, editors, and partners covering BottleExpress and the world of luxury spirits."
    >
      ...
      <ProseSection title="Media enquiries">
        <p>
          ...
          <a href="mailto:press@bottleexpress.com">press@bottleexpress.com</a>. High-resolution
