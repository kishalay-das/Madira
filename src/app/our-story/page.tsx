...
export const metadata: Metadata = {
  title: "Our Story",
  description:
    "How Nocturne became a modern luxury house for the world's finest spirits — sourced, authenticated and delivered with concierge care.",
};
...
export default function OurStoryPage() {
  return (
    <PageShell
      eyebrow="Company"
      title="Our Story"
      lede="Nocturne began with a simple frustration — that the world's most extraordinary bottles were the hardest to find, verify, and trust. We set out to change that."
    >
      <div className="mb-16">
        <StatRow
          stats={[
      ...
      <ProseStack>
        ...
        <ProseSection title="Concierge, not commerce">
          <p>
            Nocturne is designed to feel less like a store and more like a private cellar
