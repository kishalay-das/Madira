...
export const metadata: Metadata = {
  ...
  description:
    "The terms that govern your use of Madeera and your purchases of fine spirits.",
};
...
export default function TermsPage() {
  return (
    <PageShell
      eyebrow="Legal"
      title="Terms of Service"
      lede="These terms govern your use of Madeera. By browsing or ordering, you agree to them."
    >
      <ProseStack>
        <ProseSection title="Eligibility & age">
          <p>
            You must be of legal drinking age (21+ where applicable) to purchase
            from Madeera. Age is verified at checkout and again on delivery, and a
        ...
        <ProseSection title="Liability">
          <p>
            Madeera is provided on a reasonable-efforts basis. To the fullest
