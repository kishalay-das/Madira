...
export const metadata: Metadata = {
  ...
  description:
    "BottleExpress celebrates spirits as a craft to be savoured. Our commitment to age verification and drinking responsibly.",
};
...
export default function ResponsibleDrinkingPage() {
  return (
    <PageShell
      ...
      lede="BottleExpress exists to celebrate the craft of great spirits — and great spirits are meant to be savoured, never abused."
    >
      <div className="mb-16">
