...
export const metadata: Metadata = {
  ...
  description:
    "Every bottle BottleExpress ships is sourced, inspected, and sealed through a verified chain of custody — guaranteed authentic or your money back.",
};
  ...
  return (
    ...
    >
      ...
      <ProseSection title="Our guarantee, in plain terms">
        <p>
          Every order is backed by the BottleExpress Authenticity Guarantee. If an independent
