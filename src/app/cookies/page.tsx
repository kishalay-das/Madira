...
export const metadata: Metadata = {
  title: "Cookie Policy",
  description:
    "How and why BottleExpress uses cookies and similar technologies, and how to control them.",
};
...
export default function CookiesPage() {
  return (
    <PageShell
      eyebrow="Legal"
      title="Cookie Policy"
      lede="Cookies help BottleExpress remember your session, your cart, and your preferences. Here's how we use them and how to manage them."
    >
      <ProseStack>
