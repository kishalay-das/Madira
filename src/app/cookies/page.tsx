...
export const metadata: Metadata = {
  title: "Cookie Policy",
  description:
    "How and why Kishalay Madeera uses cookies and similar technologies, and how to control them.",
};
...
export default function CookiesPage() {
  return (
    <PageShell
      eyebrow="Legal"
      title="Cookie Policy"
      lede="Cookies help Kishalay Madeera remember your session, your cart, and your preferences. Here's how we use them and how to manage them."
    >
      <ProseStack>
